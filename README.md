...
<head>
    ...
    <style>
        body {
            ...
            padding: 0;
            text-align: center;
            background-color: #f4f4f4; /* Changed background color of body */
        }
        .banner {
            background-color: #f8a5a5; /* Changed background color of banner */
            padding: 15px;
            color: white;
        }
        .nav-links {
        ...
        .welcome-section, .features-section {
            padding: 15px;
            background-color: #ffffff; /* Changed background color of sections */
            margin: 10px auto;
            width: 70%;
            border-radius: 8px;
        }
...
<body>
    ...
    <!-- Footer Section -->
    <footer>
        <p>&copy; DESIGNED BY: S S SHARVESHWARAN </p>
    </footer>
</body>
</html>
administration.html
...
## OUTPUT:
![alt text](<Screenshot 2024-12-26 152020.png>)
![alt text](<Screenshot 2024-12-26 152028.png>)
![alt text](<Screenshot 2024-12-26 152146.png>)
![alt text](<Screenshot 2024-12-26 152040.png>)
